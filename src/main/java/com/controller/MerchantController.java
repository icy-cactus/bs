...
public class MerchantController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		MerchantEntity u = merchantService.selectOne(new EntityWrapper<MerchantEntity>().eq("merchantusername", username));
		if(u==null || !u.getPassword().equals(password)) {
			return R.error("账号或密码不正确");
		}
		
		String token = tokenService.generateToken(u.getId(), username,"merchant",  "商家" );
    ...
    public R register(@RequestBody MerchantEntity merchant){
    	...
    	MerchantEntity u = merchantService.selectOne(new EntityWrapper<MerchantEntity>().eq("merchantusername", merchant.getMerchantusername()));
		if(u!=null) {
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<MerchantEntity> wrapper = new EntityWrapper<MerchantEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = merchantService.selectCount(wrapper);
