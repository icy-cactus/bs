<template>
	<div>
		<div :style='{ "width": "1200px", "padding": "10px", "margin": "12px auto 0", "borderRadius": "16px", "background": "#BAD399" }'
		...
		<div class="detail-preview"
			:style='{ "width": "1200px", "padding": "0 0 20px", "margin": "0px auto", "position": "relative", "background": "none" }'>
			<div class="attr"
				:style='{ "border": "2px solid #bad399", "padding": "20px", "margin": "20px 0 0 0", "overflow": "hidden", "borderRadius": "8px", "flexWrap": "wrap", "background": "#fff", "display": "flex", "position": "relative", "justifyContent": "space-between", "height": "auto" }'>
				<el-carousel
					:style='{ "width": "500px", "margin": "0px 0", "borderRadius": "8px", "height": "500px", "order": "1" }'
					trigger="click" indicator-position="inside" arrow="always" type="default" direction="horizontal"
					height="500px" autoplay="true" interval="3000" loop="true">
					<el-carousel-item :style='{ "borderRadius": "8px", "width": "100%", "height": "100%" }'
						v-for="item in detailBanner" :key="item.id">
						<el-image
							:style='{ "width": "100%", "objectFit": "cover", "borderRadius": "8px", "height": "100%" }'
				...
				<div class="zancai"
					:style='{ "padding": "0", "margin": "0 0", "top": "536px", "flexWrap": "wrap", "background": "none", "display": "flex", "width": "500px", "position": "absolute", "justifyContent": "center" }'>
					<div :style='{ "cursor": "pointer", "padding": "10px 10px", "margin": "0 20px 0 0", "alignItems": "center", "borderRadius": "8px", "background": "#bad399", "display": "flex", "width": "auto", "justifyContent": "center" }'
						...
						<span :style='{ "color": "#fff", "margin": "0 3px", "fontSize": "14px" }'>赞一下({{
							detail.thumbsupnum }})</span>
					</div>
					<div :style='{ "cursor": "pointer", "padding": "10px 10px", "margin": "0 20px 0 0", "alignItems": "center", "borderRadius": "8px", "background": "#bad399", "display": "flex", "width": "auto", "justifyContent": "center" }'
						v-if="!isThumbsupnum && !isCrazilynum" class="cai" @click="thumbsupOrCrazily(22)">
						<i :style='{ "color": "#fff", "margin": "0 3px", "fontSize": "14px" }'
							class="iconfont icon-iconfontzan"></i>
						<span :style='{ "color": "#fff", "margin": "0 3px", "fontSize": "14px" }'>踩一下({{
							detail.crazilynum }})</span>
					</div>
					<div :style='{ "cursor": "pointer", "padding": "10px 10px", "margin": "0 20px 0 0", "alignItems": "center", "borderRadius": "8px", "background": "#bad399", "display": "flex", "width": "auto", "justifyContent": "center" }'
						v-if="isThumbsupnum" class="zan" @click="cancelThumbsupOrCrazily(21)">
						<i :style='{ "color": "#fff", "margin": "0 3px", "fontSize": "14px" }'
							class="iconfont icon-dianzan"></i>
						<span :style='{ "color": "#fff", "margin": "0 3px", "fontSize": "14px" }'>取消赞({{
							detail.thumbsupnum }})</span>
					</div>
					<div :style='{ "cursor": "pointer", "padding": "10px 10px", "margin": "0 20px 0 0", "alignItems": "center", "borderRadius": "8px", "background": "#bad399", "display": "flex", "width": "auto", "justifyContent": "center" }'
						...
						<i :style='{ "color": "#fff", "margin": "0 3px", "fontSize": "14px" }'
							class="iconfont icon-iconfontzan"></i>
						<span :style='{ "color": "#fff", "margin": "0 3px", "fontSize": "14px" }'>取消踩({{
							detail.crazilynum }})</span>
					</div>
				</div>

				<div class="info"
					:style='{ "minHeight": "570px", "padding": "0 20px 20px", "margin": "0px", "borderRadius": "8px", "background": "#f9f9f9", "width": "600px", "height": "auto", "order": "2" }'>
					<div class="item"
						:style='{ "padding": "10px", "margin": "0 0 20px 0", "borderColor": "#bad399", "alignItems": "center", "background": "none", "borderWidth": "0 0 1px 0", "display": "flex", "borderStyle": "solid", "justifyContent": "space-between" }'>
						<div :style='{ "color": "#333", "fontSize": "16px", "fontWeight": "bold" }'>
							{{ detail.restaurantname }}<span class="rating-score">★{{ detail.rating || 0.0 }}/10.0</span>
						</div>
						<div @click="storeup(1)" v-show="!isStoreup"
							:style='{ "cursor": "pointer", "padding": "10px", "borderRadius": "8px", "background": "#bad399" }'>
							<i v-if="true" :style='{ "color": "#fff", "fontSize": "14px" }'
								class="el-icon-star-off"></i><span
								:style='{ "color": "#fff", "fontSize": "14px" }'>点我收藏</span>
						</div>
						<div @click="storeup(-1)" v-show="isStoreup"
							:style='{ "cursor": "pointer", "padding": "10px", "borderRadius": "8px", "background": "#bad399" }'>
							<i v-if="true" :style='{ "color": "#fff", "fontSize": "14px" }'
								class="el-icon-star-on"></i><span
								:style='{ "color": "#fff", "fontSize": "14px" }'>取消收藏</span>
						</div>
					</div>

					<div class="item"
						:style='{ "padding": "4px", "margin": "0 0 4px 0", "borderColor": "#bad399", "background": "none", "borderWidth": "0 0 1px 0 ", "display": "flex", "borderStyle": "solid", "justifyContent": "spaceBetween" }'>
						<div class="lable"
							:style='{ "padding": "0 10px 0 0", "color": "#333", "textAlign": "left", "width": "130px", "fontSize": "14px", "lineHeight": "24px", "fontWeight": "bold", "height": "40px" }'>
							餐厅地点</div>
						<div
							:style='{ "width": "498px", "padding": "0 10px", "fontSize": "14px", "lineHeight": "24px", "color": "#666" }'>
							{{ detail.address }}</div>
					</div>
					<div class="item"
						:style='{ "padding": "4px", "margin": "0 0 4px 0", "borderColor": "#bad399", "background": "none", "borderWidth": "0 0 1px 0 ", "display": "flex", "borderStyle": "solid", "justifyContent": "spaceBetween" }'>
...
<div class="item"
					...
					<div class="btn" :style='{ "padding": "10px 0 0", "flexWrap": "wrap", "display": "flex" }'>
						<el-button
							:style='{ "border": "0", "cursor": "pointer", "padding": "0 10px", "margin": "0px 5px 5px 0", "outline": "none", "color": "#383838", "borderRadius": "4px", "background": "#bad399", "width": "auto", "lineHeight": "40px", "fontSize": "14px", "height": "40px" }'
							v-if="isAuth('restaurantinfo', '订餐厅')" @click="onAcross('restaurantreserve', '', '', '')"
							type="warning">订餐厅</el-button>
					</div>
				</div>
			...
			<el-tabs class="detail"
				:style='{ "border": "2px solid #bad399", "boxShadow": "none", "padding": "20px", "margin": "20px 0 0 0", "borderRadius": "8px", "background": "#fff" }'
				v-model="activeName" type="border-card">
				<el-tab-pane label="餐厅介绍" name="first">
					<div v-html="detail.introduce"></div>
				</el-tab-pane>
				<el-tab-pane label="评论" name="second">
					<el-form class="add comment"
						:style='{ "padding": "0", "margin": "20px 0 20px", "position": "relative", "background": "none" }'
						:model="form" :rules="rules" ref="form">
						<el-form-item class="item"
							:style='{ "border": "2px solid #bad399", "width": "100%", "boxShadow": "inset 0px 0px 48px 0px #f0faf4", "borderRadius": "8px", "display": "flex", "height": "auto" }'
							label="评论" prop="content">
							<el-input type="textarea" :rows="5" v-model="form.content" placeholder="请输入内容"></el-input>
						</el-form-item>
						<el-form-item class="btn"
							:style='{ "width": "100%", "padding": "0 0 0 80px", "margin": "10px 0 0", "justifyContent": "space-around", "display": "flex", "height": "auto" }'>
							<el-button
								:style='{ "border": "0", "cursor": "pointer", "padding": "0", "margin": "0 20px 0 0", "outline": "none", "color": "rgba(255, 255, 255, 1)", "borderRadius": "20px", "background": "#bad399", "width": "128px", "lineHeight": "40px", "fontSize": "14px", "height": "40px" }'
								type="primary" @click="submitForm('form')">立即提交</el-button>
							<el-button
								:style='{ "border": "2px solid #bad399", "cursor": "pointer", "padding": "0", "margin": "0 20px 0 0", "outline": "none", "color": "#bad399", "borderRadius": "20px", "background": "#eef6f1", "width": "128px", "lineHeight": "40px", "fontSize": "14px", "height": "40px" }'
								@click="resetForm('form')">重置</el-button>
						</el-form-item>
					</el-form>

					<div v-if="infoList.length" :style='{ "padding": "0px" }' class="comment">
						<div :style='{ "padding": "8px 0", "margin": "0 0 20px", "borderColor": "#a2c6af", "alignItems": "center", "borderWidth": "0 0 1px 0", "width": "100%", "borderStyle": "solid", "height": "auto" }'
							...
							<div class="user"
								...
								<el-image v-if="!item.avatarurl"
									:style='{ "width": "40px", "margin": "0 10px 0 0", "borderRadius": "100%", "objectFit": "cover", "height": "40px" }'
									:size="50" :src="require('@/assets/avatar.png')"></el-image>
								<div :style='{ "color": "#333", "fontSize": "16px" }' class="name">{{ item.nickname }}
								</div>
							</div>
							<div :style='{ "padding": "8px", "margin": "10px 0px 0px", "color": "#333", "borderRadius": "4px", "background": "none", "lineHeight": "30px", "fontSize": "14px", "textIndent": "2em" }'
					...
					<el-pagination background class="pagination" :pager-count="7" :page-size="pageSize"
						:page-sizes="pageSizes" prev-text="上一页" next-text="下一页" :hide-on-single-page="false"
				...
				<el-tab-pane label="评价" name="fourth">
					...
					<div v-if="reviewList.length" :style='{ "padding": "0px" }' class="comment">
						<div :style='{ "padding": "8px 0", "margin": "0 0 20px", "borderColor": "#a2c6af", "alignItems": "center", "borderWidth": "0 0 1px 0", "width": "100%", "borderStyle": "solid", "height": "auto" }'
							v-for="item in reviewList" :key="item.id">
							<div class="user"
								:style='{ "width": "100%", "alignItems": "center", "display": "flex", "height": "auto" }'>
								<el-image v-if="item.avatar"
									:style='{ "width": "40px", "margin": "0 10px 0 0", "borderRadius": "100%", "objectFit": "cover", "height": "40px" }'
									:size="50" :src="baseUrl + item.avatar"></el-image>
								<el-image v-if="!item.avatar"
									:style='{ "width": "40px", "margin": "0 10px 0 0", "borderRadius": "100%", "objectFit": "cover", "height": "40px" }'
									:size="50" :src="require('@/assets/avatar.png')"></el-image>
								<div :style='{ "color": "#333", "fontSize": "16px", "margin": "0 10px 0 10px" }'
									class="name">{{ item.username }}
								</div>
								<div class="rating-score">
									{{ item.rating >= 10 ? '★★★★★' : item.rating >= 8 ? '★★★★' : item.rating >= 6 ?
										'★★★' : item.rating >= 4 ? '★★' : '★' }}
								</div>
								<div :style='{ "color": "#333", "fontSize": "16px", "margin": "0 10px 0 10px" }'
									class="name">{{ item.addtime }}
								</div>
							</div>
							<div :style='{ "padding": "8px", "margin": "10px 0px 0px", "color": "#333", "borderRadius": "4px", "background": "none", "lineHeight": "30px", "fontSize": "14px", "textIndent": "2em" }'
								class="content-block-ask">
...
export default {
	...
	methods: {
		init() {
			...
			this.$http.get(this.tablename + '/detail/' + this.detail.id, {}).then(res => {
				if (res.data.code == 0) {
					...
					this.title = this.detail.restaurantname;
					this.detailBanner = this.detail.restaurantphoto ? this.detail.restaurantphoto.split(",") : [];
					this.$forceUpdate();
				}
			});
		...
		onAcross(acrossTable, crossOptAudit, statusColumnName, tips, statusColumnValue) {
			localStorage.setItem('crossTable', `restaurantinfo`);
		...
		getStoreupStatus() {
			if (localStorage.getItem("Token")) {
				this.$http.get('storeup/list', { params: { page: 1, limit: 1, type: 1, refid: this.detail.id, tablename: 'restaurantinfo', userid: localStorage.getItem('userid') } }).then(res => {
		...
		thumbsupOrCrazily(type) {
			...
			this.$http.post('restaurantinfo/update', this.detail).then(res => { });
		},
		...
		getThumbsupOrCrazilyStatus() {
			if (localStorage.getItem("Token")) {
				this.$http.get('storeup/list', { params: { page: 1, limit: 1, type: 21, refid: this.detail.id, tablename: 'restaurantinfo', userid: localStorage.getItem('userid') } }).then(res => {
					if (res.data.code == 0 && res.data.data.list.length > 0) {
				...
				this.$http.get('storeup/list', { params: { page: 1, limit: 1, type: 22, refid: this.detail.id, tablename: 'restaurantinfo', userid: localStorage.getItem('userid') } }).then(res => {
					if (res.data.code == 0 && res.data.data.list.length > 0) {
		...
		getDiscussList(page) {
			this.$http.get('discussrestaurantinfo/list', { params: { page, limit: this.pageSize, refid: this.detail.id } }).then(res => {
				if (res.data.code == 0) {
			...
			this.$http.get('restaurantreserve/list', { params: { page, limit: this.pageSize, refid: this.detail.id, sfsh: '已评价' } }).then(res => {
				if (res.data.code == 0) {
					this.reviewList = res.data.data.list;
					this.reviewtotal = res.data.data.total;
					this.reviewpageSize = res.data.data.pageSize; this.reviewpageSizes = [this.reviewpageSize, this.reviewpageSize * 2, this.reviewpageSize * 3, this.reviewpageSize * 5];
					this.reviewtotalPage = res.data.data.totalPage;
				}
			});
		},
		submitForm(formName) {
			...
			this.$refs[formName].validate((valid) => {
				if (valid) {
					...
					this.$http.post('discussrestaurantinfo/add', this.form).then(res => {
						if (res.data.code == 0) {
							this.form.content = '';
							this.getDiscussList(1);
							this.$message({
