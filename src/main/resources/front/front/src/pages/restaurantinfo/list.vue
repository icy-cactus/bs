    ...
    >
      ...
      >
        <el-form-item :style="{ margin: '10px' }">
          ...
          <el-input
            v-model="formSearch.restaurantname"
            placeholder="餐厅名称"
            clearable
          ></el-input>
        </el-form-item>
        ...
        <el-button
          ...
          type="primary"
          @click="add('/index/restaurantinfoAdd')"
          ><i
            v-if="true"
            :style="{ color: '#fff', margin: '0 10px 0 0', fontSize: '14px' }"
      ...
      <div class="list" :style="{ margin: '20px 0 0 0', flex: '1' }">
        ...
        >
          ...
          <!-- 景点图片区域 -->
          <img
            v-if="item.restaurantphoto && item.restaurantphoto.substr(0, 4) === 'http'"
            :src="item.restaurantphoto"
            class="list-image"
          />
          <img
            v-else
            :src="
              baseUrl + (item.restaurantphoto ? item.restaurantphoto.split(',')[0] : '')
            "
            class="list-image"
          />
          ...
          <div class="item-info">
            ...
            <div v-if="item.reserveprice" class="list-price">
              <span class="price-symbol">￥</span>{{ item.reserveprice }}
...
export default {
  ...
  methods: {
    ...
    getList(page, fenlei, ref = "") {
      ...
      let searchWhere = {};
      if (this.formSearch.restaurantname != "")
        searchWhere.restaurantname = "%" + this.formSearch.restaurantname + "%";
      if (this.formSearch.address != "")
        searchWhere.address = "%" + this.formSearch.address + "%";
      this.$http
        .get("restaurantinfo/list", {
    ...
    toDetail(item) {
      this.$router.push({
        path: "/index/restaurantinfoDetail",
