		...
		<el-form
			...
			<template>
				...
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' class="input" v-if="type != 'info'"
					...
					<el-input v-model="ruleForm.hoteltype" placeholder="酒店类型" clearable
						:readonly="ro.hoteltype"></el-input>
				</el-form-item>
				...
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' class="input" v-if="type != 'info'"
					...
					<el-input v-model="ruleForm.roomtype" placeholder="房间类型" clearable
						:readonly="ro.roomtype"></el-input>
				</el-form-item>
				...
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' class="input" v-if="type != 'info'"
					...
					<el-input v-model="ruleForm.roomno" placeholder="房间号" clearable :readonly="ro.roomno"></el-input>
				</el-form-item>
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' v-else class="input" label="房间号"
					prop="roomno">
					<el-input v-model="ruleForm.roomno" placeholder="房间号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' class="input" v-if="type != 'info'"
				...
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' class="date" v-if="type != 'info'"
					label="预订时间" prop="reservetime">
					<el-date-picker value-format="yyyy-MM-dd HH:mm:ss" v-model="ruleForm.reservetime" type="datetime"
						:readonly="ro.reservetime" placeholder="预订时间"></el-date-picker>
				</el-form-item>
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' class="input"
					v-else-if="ruleForm.reservetime" label="预订时间" prop="reservetime">
					<el-input v-model="ruleForm.reservetime" placeholder="预订时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' class="input" v-if="type != 'info'"
					label="预订说明" prop="reserveremark">
					<el-input v-model="ruleForm.reserveremark" placeholder="预订说明" clearable
						:readonly="ro.reserveremark"></el-input>
				</el-form-item>
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' v-else class="input" label="预订说明"
					prop="reserveremark">
					<el-input v-model="ruleForm.reserveremark" placeholder="预订说明" readonly></el-input>
				</el-form-item>

				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' class="input" v-if="type != 'info'"
					label="商家名称" prop="merchantname">
					<el-input v-model="ruleForm.merchantname" placeholder="商家名称" clearable
						:readonly="ro.merchantname"></el-input>
				</el-form-item>
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' v-else class="input" label="商家名称"
					prop="merchantname">
				...
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' class="input" v-if="type != 'info'"
					label="手机" prop="telephone">
					<el-input v-model="ruleForm.telephone" placeholder="手机" clearable
				...
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' v-else class="input" label="评分"
					prop="rating">
					<el-input v-model="ruleForm.rating" placeholder="评分" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' class="input" v-if="type != 'info'"
					label="评价" prop="review">
					<el-input v-model="ruleForm.review" placeholder="评价" clearable :readonly="ro.review"></el-input>
				</el-form-item>
				<el-form-item :style='{ "width": "100%", "margin": "0 0 20px 0" }' v-else class="input" label="评价"
					prop="review">
						...
						this.$http({
							...
							if (data && data.code === 0) {
								if (data.data.total >= crossoptnum) {
									...
									this.$http({
										url: `hotelreserve/${!this.ruleForm.id ? "save" : "update"}`,
										method: "post",
										data: this.ruleForm
									}).then(({ data }) => {
										if (data && data.code === 0) {
											this.$message({
												...
												onClose: () => {
													...
													this.parent.hotelreserveCrossAddOrUpdateFlag = false;
													this.parent.search();
